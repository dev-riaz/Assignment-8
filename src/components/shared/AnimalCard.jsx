    ...
    <div>
      <div className="card shadow-sm bg-white rounded-2xl">
        <div className="flex justify-center items-center">
            <Image className="w-full h-50 rounded-t-2xl" src={image} height={200} width={200} alt="cow image"></Image>
        </div>
        <div className="p-3 space-y-2 text-[#42654d]">
          ...
          <div className="">
            <button className="btn w-full rounded-xl bg-[#0c4532] text-white">View Details</button>
          </div>
        </div>
      </div>
    </div>
